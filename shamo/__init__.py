...
from .problems.forward.eeg.eeg_parametric_forward_problem \
    import EEGParametricForwardProblem
...
from .solutions.forward.eeg.eeg_parametric_forward_solution \
    import EEGParametricForwardSolution
...
__all__ = ["ConstantDistribution", "UniformDistribution",
           ...
           "EEGSimulationSolution", "EEGParametricForwardSolution"]
